...
public class Splash {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if (splash == null) {
			splash = new ResourceLocation("Lsmp/wp.jpg");
		}
		tm.bindTexture(splash);
		GlStateManager.resetColor();
		GlStateManager.color(1.0f , 1.0f , 1.0f , 1.0f);
		Gui.drawScaledCustomSizeModalRect(0, 0, 0, 0, 1366, 768, scaledResolution.getScaledWidth() , scaledResolution.getScaledHeight(), 1366, 768);
		drawProgress();
	...
	if(ufr == null) {
		ufr = UnicodeFontRenderer.getFontOnPC("Helvetica",20);
	} 
	...
	ufr.drawString(CURRENT, 20, sr.getScaledHeight() -25, 0xffffff);
